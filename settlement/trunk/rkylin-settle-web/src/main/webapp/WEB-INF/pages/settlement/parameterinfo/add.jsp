...
<body onclick="closeSelect()">
	<div class="area">
		<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/parameterinfo/save_ajax">
			<div class="main">
				<div class="blank15"></div>
				<div class="wrap">	
					<div class="con">
						<div class="con_title">
							<h3 class="left fs14 marglr3020">新增系统参数信息</h3>
							<div class="attr_con">
							...
							<div class="con_article_title02 paddtb20">
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="parameterType" name="parameterType" class="wid190 required" title="请输入参数类型"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="productId" name="productId" class="wid190"/>
									</div>
								</div>
								<!-- // 参数类型、产品ID -->
								<!-- 参数编码、参数值 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="parameterCode" name="parameterCode" class="wid190 required" title="请输入参数编码"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="parameterValue" name="parameterValue" class="wid190 required" title="请输入参数值"/>
									</div>
								</div>
								<!-- // 参数编码、参数值 -->
								<!-- 预留1、预留2 -->
