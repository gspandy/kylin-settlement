			...
			else
			{
				...
				if(stype == "password" || stype == "text" || stype == "file")
				{
					...
					if(onShowClass!="" && showclass == "onShow"){
						jqobj.removeClass(onFocusClass).removeClass(onCorrectClass).removeClass(onErrorClass)
							 .addClass(onShowClass);
					};
					if(onFocusClass!="" && showclass == "onFocus"){
						jqobj.removeClass(onShowClass).removeClass(onCorrectClass).removeClass(onErrorClass)
							 .addClass(onFocusClass);
					};
					if(onCorrectClass!="" && showclass == "onCorrect"){
						jqobj.removeClass(onShowClass).removeClass(onFocusClass).removeClass(onErrorClass)
							 .addClass(onCorrectClass);
					};
...
var fv_scriptSrc = "js/common/formValidator-4.1.1.js";