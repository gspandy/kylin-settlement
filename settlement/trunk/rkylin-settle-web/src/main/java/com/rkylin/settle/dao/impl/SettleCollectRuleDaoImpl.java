...
public class SettleCollectRuleDaoImpl extends BaseDao implements SettleCollectRuleDao {
	...
	@Override
	public List<SettleCollectRule> selectByPreExample(SettleCollectRuleQuery example) {
		return super.getSqlSession().selectList("SettleCollectRuleMapper.selectByPreExample", example);
	}
}
