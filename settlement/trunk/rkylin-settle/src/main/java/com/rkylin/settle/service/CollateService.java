...
public interface CollateService {
	 ...
	 * @param accountDate  账期
	 * @param fileType 文件类型
	 * @param payChannelId S05
	 */
	public void InowPayFileDownAndReadCollateFile(String marchantCode, String readType, String accountDate, String fileType, String payChannelId) throws Exception;
