CREATE TABLE `SETTLE_KERNEL_ENTRY` (
  ...
  `TRANS_ENTRY_SA_ID` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '会计交易流水ID',
  ...
  `PAYMENT_AMOUT1` decimal(18,0) unsigned DEFAULT '0' COMMENT '发生额1',
  ...
  `PAYMENT_AMOUT2` decimal(18,0) unsigned DEFAULT '0' COMMENT '发生额2',
  ...
  `STATUS_ID` tinyint(3) unsigned DEFAULT '1' COMMENT '清结算状态ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='交易流水表';
