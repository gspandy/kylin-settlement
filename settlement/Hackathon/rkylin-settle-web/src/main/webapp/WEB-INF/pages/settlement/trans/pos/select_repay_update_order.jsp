...
<title>查询还款交易手续费并更新订单系统</title>

<jsp:include page="../../../base/base_page.jsp"/>
<style type="text/css">
	.divhide {display:none}
</style>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/trans/select_repay_update_order.js"></script>
</head>
<div class="area">
	<form name="dataForm" id="dataForm" action="${pageContext.request.contextPath}/posdetail/select_repay_update_order" >
		<div class="main">
			<div class="blank15"></div>
			<div class="wrap">
				<div class="con">
					<div class="con_title">
						<h3 class="left fs14 marglr3020">查询还款交易手续费并更新订单系统</h3>
					...
					<div class="main_con" style="display: ">
							...
							<div class="con_article_title02 margt10 tit_zindex3">
								<a href="javascript:void(0);" class="right chan_btn wid60 margr30 margt5" onclick="summary();">确认</a>
							</div>
					</div>
				</div>
			</div>
