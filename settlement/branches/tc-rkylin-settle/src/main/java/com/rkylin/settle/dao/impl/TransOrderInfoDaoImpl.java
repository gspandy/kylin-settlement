...
public class TransOrderInfoDaoImpl extends AccountBaseDao implements TransOrderInfoDao {
	...
	@Override
    public List<TransOrderInfo> selectByRequestTime(Map<String, Object> example) {
        return super.getSqlSession().selectList("TransOrderInfoMapper.selectByRequestTime", example);
    }
}
