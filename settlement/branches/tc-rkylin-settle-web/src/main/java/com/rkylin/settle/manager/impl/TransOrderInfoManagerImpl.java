...
public class TransOrderInfoManagerImpl implements TransOrderInfoManager {
	...
	@Override
	public List<TransOrderInfo> queryPage(TransOrderInfoQuery query) {
		return transOrderInfoDao.selectByPreExample(query);
	}

	@Override
	public Integer countByExample(TransOrderInfoQuery query) {
		return transOrderInfoDao.countByExample(query);
	}
}
