 ...
 */
public class MtkernelBaseDao extends SqlSessionDaoSupport {


    @Autowired(required = false)
    @Qualifier("sqlSessionFactory4")
    public void setSqlSessionFactory4(SqlSessionFactory sqlSessionFactory) {
