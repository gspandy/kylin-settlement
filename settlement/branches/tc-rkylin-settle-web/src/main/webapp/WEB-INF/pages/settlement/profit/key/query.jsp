...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/profit/keyQuery.js"></script>
</head>
<div class="area">
				...
				<div class="con">
					...
					<div class="main_con" style="display: ">
						...
						<div class="con_article_title02 tit_zindex6" id="reg2_arrow_con">
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								...
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="profitKeyId" id="profitKeyId" />
								</div>
								...
								<label class="label_txt wid135 txtright margr8 margt11 margl16">产品号： </label>
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="funcCode" id="funcCode" />
								</div>
							</div>
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								<label class="label_txt wid135 txtright margr8 margt11">规则key1名称： </label>
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="keyName1" id="keyName1" />
								</div>
								<label class="label_txt wid135 txtright margr8 margt11">规则key1值： </label>
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="keyValue1" id="keyValue1" />
								</div>
								<label class="label_txt wid135 txtright margr8 margt11 margl16">规则明细ID： </label>
								<div class="input_con_type_top wid190 margt4">
						...
						<div class="con_core_info_main wid1125 paddl10 margt10" style="width:1225px;">
							<ul class="table_menu">
								<li>
									<a class="left chan_btn wid100 margl10 margt5" id="addBtn" href="profitkey/key_open_add">新增清分规则</a>
								</li>
							</ul>
