...
public class SettleConstants {
	...
	public static final String XR_XJDD_PATH = PathPropertiesUtil.getPathProperties().getProperty("xrXjdDPath");
	public static final String MY_DOWNLOAD_PATH = TOMCAT_ROOT_PATH + "my_download"  + File.separator;
	public static final String MY_DOWNLOAD_MODEL = "my_download_model.xlsx";
	public static final String DEFAULT_MODEL = "default.xlsx";
	...
	public static final String PARAMETER_TYPE_BILL_NO="1000000011";//挂账交易状态常量-不允许挂账交易状态
	public static final String PARAMETER_DOWN_MERCHANT="1000000013";//下游机构编码
	...
	public static final int INVOICE_ISBILLED =98;//异常
	...
	/************汇总  start******************/
	public static final int COLLECT_TYPE_1 = 1;//应收
	public static final int COLLECT_TYPE_2 = 2;//实收 	代收付	成功
	public static final int COLLECT_TYPE_3 = 3;//实收 	代收付 	失败
	public static final int COLLECT_TYPE_4 = 4;//实收		 充值 		成功
	public static final int COLLECT_TYPE_5 = 5;//实收		 退款 		退票
//	public static final String COLLECT_MQKEY = "mqsettle001";	//开发
	public static final String COLLECT_MQKEY = "mqsettle002";	//测试
	/************汇总  end******************/
