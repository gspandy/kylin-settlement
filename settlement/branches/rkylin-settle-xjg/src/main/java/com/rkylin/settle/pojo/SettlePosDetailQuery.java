...
/**
 * SettlePosDetailQuery
 * @author code-generator
 *
 */
public class SettlePosDetailQuery implements Serializable{
	...
	/**
	 * 0未处理;1处理中;4代收付失败;40 代收付失败，结果推送账户失败;41 代收付失败，结果推送账户成功;6 代收付成功;60 代收付成功，结果推送账户失败;61 代收付成功，结果推送账户成功;99 异常;null非代收付交易单
	 * @param dflag
	 */
