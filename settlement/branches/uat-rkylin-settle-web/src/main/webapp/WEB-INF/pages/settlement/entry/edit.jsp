							...
							<div class="con_core_info margt20">
								...
								<div class="con_core_info_div02">
									...
									<label class="label_txt wid190 margt11">
										...
										${(settleBalanceEntry.balanceType==1)? '【分润】 账户系统':''}
										${(settleBalanceEntry.balanceType==2)? '【对账】 账户&多渠道系统':''}
										<input type="hidden" value="${settleBalanceEntry.balanceType}" name="balanceType" />
									</label>
								</div>
								<!-- // 结果类型 -->
								<!-- 结果类型 -->
								...
								<div class="con_core_info_div02">
									...
									<div class="input_con_type_top wid190 margt4">
										<select style="width:189px;height:28px;" name="statusId">
											...
											<option style="height:25px" value="4" ${(settleBalanceEntry.statusId==4)?'selected':''}>【对账】 其他环境</option>
