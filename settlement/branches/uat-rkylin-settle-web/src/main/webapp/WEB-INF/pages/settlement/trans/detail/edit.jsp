...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/trans/detailEdit.js"></script>
</head>
						...
						<div class="main_con">
							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="feeAmount" id="feeAmount" value="${settleTransDetail.feeAmount}" />
								</div>
							</div>
							<!-- // 入账金额、手续费金额 -->
							<!-- 用户手续费、业务类型 -->
							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="userFee" id="userFee" value="${settleTransDetail.userFee}" />
								</div>
								<label class="label_txt wid130 txtright margt10 margr8">
							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="statusId">
										<option style="height:25px" value="0" ${(settleTransDetail.statusId==0)?'selected':''}>【交易】失败</option>
										<option style="height:25px" value="1" ${(settleTransDetail.statusId==1)?'selected':''}>【交易】成功</option>
										<option style="height:25px" value="2" ${(settleTransDetail.statusId==2)?'selected':''}>【交易】不明</option>
										<option style="height:25px" value="10" ${(settleTransDetail.statusId==10)?'selected':''}>【清分】失败</option>
										<option style="height:25px" value="11" ${(settleTransDetail.statusId==11)?'selected':''}>【清分】成功</option>
										<option style="height:25px" value="20" ${(settleTransDetail.statusId==20)?'selected':''}>【对账】异常</option>
										<option style="height:25px" value="21" ${(settleTransDetail.statusId==21)?'selected':''}>【对账】平账</option>
										<option style="height:25px" value="22" ${(settleTransDetail.statusId==22)?'selected':''}>【对账】错帐</option>
										<option style="height:25px" value="24" ${(settleTransDetail.statusId==24)?'selected':''}>【对账】短款</option>
										<option style="height:25px" value="40" ${(settleTransDetail.statusId==40)?'selected':''}>【清算】失败</option>
										<option style="height:25px" value="41" ${(settleTransDetail.statusId==41)?'selected':''}>【清算】成功</option>
									</select>
								</div>
							</div>
							<!-- // 结算订单号、状态 -->
							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="readStatusId" value="${settleTransDetail.readStatusId}" />
								</div>
								<%-- <label class="label_txt wid190 margt11">
								<c:choose>
