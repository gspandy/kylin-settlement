 ...
 */
public class OrderBaseDao extends SqlSessionDaoSupport {


    @Autowired(required = false)
    @Qualifier("sqlSessionFactory_order")
    public void setSqlSessionFactory_order(SqlSessionFactory sqlSessionFactory) {
