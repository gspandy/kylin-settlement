...
public class TransDetailInfoManagerImpl implements TransDetailInfoManager {
	...
	@Override
	public List<TransDetailInfo> selectByAccountDate(TransDetailInfoQuery query) {
		return transDetailInfoDao.selectByAccountDate(query);
	}
	...
	public List<TransDetailInfo> selectByUpdateTime(Map<String,Object> query) {
		return transDetailInfoDao.selectByUpdateTime(query);
	}
}
