...
public interface SettleWebInterface {
	 ...
	 * @param collectType
	 */
	public void doCollectForAccLogic(Integer collectType, Date accountDate) throws Exception;
	/**
	 * 发送汇总交易记账
	 * @param ske
	 * @throws Exception
	 */
	public Map<String, String> doCollectBySettleKernelEntryForAccLogic(Long id) throws Exception;
	/**
	 * 核销 全规则
	 */
