...
public class SettleConstants {
	...
	// 对账状态-其他环境长款
	public static final int COLLATE_STU_4 = 4;
	// 对账文件生成路径
	...
	public static final int STATUS_COLLATE_OE_SUCCESS =211; //其他环境对账成功 平账（其实是判断出该长款来自其他环境）
	...
	/************汇总  start******************/
	public static final int COLLECT_TYPE_1 = 1;//会计系统记账 多渠道数据
	public static final int COLLECT_TYPE_2 = 2;//会计系统记账 账户二期数据
	public static final int COLLECT_TYPE_3 = 3;//账户一期记账 账户一期数据
	public static final int COLLECT_TYPE_4 = 4;//账户一期记账 多渠道数据
