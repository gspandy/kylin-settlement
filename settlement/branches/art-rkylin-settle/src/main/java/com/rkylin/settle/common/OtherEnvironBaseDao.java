 ...
 */
public class OtherEnvironBaseDao extends SqlSessionDaoSupport {


    @Autowired(required = false)
    @Qualifier("sqlSessionFactory_oe")
    public void setSqlSessionFactory_oe(SqlSessionFactory sqlSessionFactory) {
