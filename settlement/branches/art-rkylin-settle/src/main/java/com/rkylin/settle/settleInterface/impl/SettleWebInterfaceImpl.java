...
public class SettleWebInterfaceImpl implements SettleWebInterface {
	...
	@Autowired
	private AccountOtherEnvironService accountOtherEnvironService;
	@Autowired
...
//		dsfService.sendOrder(ids,null);
	...
	public void collecteAccAndMulti(String inRootInstCd,
			Date accounteDate,String readType) throws Exception {
...
//	}
	...
	public String createPositionInfo() throws Exception  {
		return positionService.createPositionInfo();
	}
	@Override
	public String createPositionInfo(String pstRootInstCd, String pstFuncCode, String pstUserId, String pstProductId) throws Exception {
		return positionService.createPositionInfo(pstRootInstCd, pstFuncCode, pstUserId, pstProductId);
	}

	@Override
	public void otherEnvironCollage(Date accountDate, String otherEnviron,String rule) throws Exception {
		accountOtherEnvironService.otherEnvironCollage(accountDate, otherEnviron,rule);
	}
	@Override
	public void doCollectForAccLogic(Integer collectType, Date accountDate)
			throws Exception {
		collectForAccLogic.doCollect(collectType, accountDate);
	}
	@Override
	public Map<String, String> doCollectBySettleKernelEntryForAccLogic(Long id)
			throws Exception {
		return collectForAccLogic.doCollectBySettleKernelEntry(id);
	}
	@Override
