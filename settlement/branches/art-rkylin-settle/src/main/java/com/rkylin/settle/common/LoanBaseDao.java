 ...
 */
public class LoanBaseDao extends SqlSessionDaoSupport {


    @Autowired(required = false)
    @Qualifier("sqlSessionFactory_loan")
    public void setSqlSessionFactory_loan(SqlSessionFactory sqlSessionFactory) {
