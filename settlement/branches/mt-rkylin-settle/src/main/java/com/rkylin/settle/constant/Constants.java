...
public class Constants {
	...
	//杏仁ID
	public static final String XR_ID = "M000029";
   ...
   public static final int ACCOUNT_NUM_STATRS_3=3;
	 ...
	 * 账户一期项目名称
	 */
	public static final String ACCOUNT_SYS_CD_ACCOUNT = "account";
	/**
	 * 账户二期项目名称
	 */
	public static final String ACCOUNT_SYS_CD_MTAEGIS = "mtaegis";
}
