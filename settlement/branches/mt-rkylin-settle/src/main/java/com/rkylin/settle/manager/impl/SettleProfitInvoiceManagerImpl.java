...
public class SettleProfitInvoiceManagerImpl implements SettleProfitInvoiceManager {
	...
	public int countByExample(SettleProfitInvoiceQuery example) {
		return settleProfitInvoiceDao.countByExample(example);
	}
	
	@Override
	public List<SettleProfitInvoice> selectInvoiceDataByMap(Map<String, Object> query) {
		return settleProfitInvoiceDao.selectInvoiceDataByMap(query);
	}
}
