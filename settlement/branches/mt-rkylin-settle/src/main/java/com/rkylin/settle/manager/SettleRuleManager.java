...
public interface SettleRuleManager {
	void saveSettleRule(SettleRule settleRule);

	void updateSettleRule(SettleRule settleRule);
	...
	void deleteSettleRuleById(Long id);
	
	void deleteSettleRule(SettleRuleQuery query);
}
