							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="dflag">
										<option style="height:25px" value="0" ${(settleTransDetail.dflag==0)?'selected':''}>【代收付】未处理</option>
										<option style="height:25px" value="1" ${(settleTransDetail.dflag==1)?'selected':''}>【代收付】处理中</option>
										<option style="height:25px" value="13" ${(settleTransDetail.dflag==13)?'selected':''}>【代收付】失败</option>
										<option style="height:25px" value="15" ${(settleTransDetail.dflag==15)?'selected':''}>【代收付】成功</option>
										<option style="height:25px" value="99" ${(settleTransDetail.dflag==99)?'selected':''}>【代收付】作废</option>
									</select>
								</div>
							</div>
