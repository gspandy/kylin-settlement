...
public class TransDetailInfoDaoImpl extends MultiBaseDao implements TransDetailInfoDao {
	...
	@Override
	public List<TransDetailInfo> selectByAccountDate(TransDetailInfoQuery example) {
		return super.getSqlSession().selectList("TransDetailInfoMapper.selectByAccountDate", example);
	}
	...
	@Override
	public List<TransDetailInfo> selectByUpdateTime(Map<String,Object> query) {
		return super.getSqlSession().selectList("TransDetailInfoMapper.selectByUpdateTime", query);
	}
}
