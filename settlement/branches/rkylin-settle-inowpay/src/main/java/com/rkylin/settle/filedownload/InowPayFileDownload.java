...
public class InowPayFileDownload extends CheckfileDownload {
	...
	public Map<String, String> fileDown(String invoicedate, String merchantCode) throws Exception {
    	...
    	try {
    		fileList = this.editInowPayFile(new File(localPath + fileName),invoicedate);
		} catch (Exception e) {
	 ...
	 * @param list
	 */
	private List<Map> editInowPayFile(File file,String invoicedate) throws Exception {
