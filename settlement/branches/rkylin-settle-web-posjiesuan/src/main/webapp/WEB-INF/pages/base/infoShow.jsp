...
<body>
    <div class="area">
        <jsp:include page="../base/base_top2.jsp"></jsp:include>
        <div class="main">
            <div class="blank15">
            </div>
            <div class="wrap">
                <div class="con">
                    ...
                    <div class="main_con">
                        ...
                        <div class="con_core_succ heig185 bord12 paddt50">
                            ...
                            <span class="succ_info fs14 margl16 margtb20">${btnMsg }</span>
                            <div class="con_core_info_div margt20">
                                <div class="attr_con wid480">
                                    <a href="${btnUrl}" class="chan_btn chan_red01 wid343">${btnInfo}</a>
                                </div>
                            </div>
                        </div>
