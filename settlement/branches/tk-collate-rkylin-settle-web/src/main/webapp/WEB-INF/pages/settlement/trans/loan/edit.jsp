...
<title>修改贷款还款信息</title>
<jsp:include page="../../../base/base_page.jsp"></jsp:include>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/trans/loanEdit.js"></script>
</head>
<body onclick="closeSelect()">
	<div class="area">
		<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/loandetail/edit_ajax">
			<div class="main">
				<div class="blank15"></div>
				<div class="wrap">	
					<div class="con">
						<div class="con_title">
							<h3 class="left fs14 marglr3020">修改贷款还款信息</h3>
							<div class="attr_con">
						...
						<div class="main_con">
							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="statusId">
										<option style="height:25px" value="0" ${(settleLoanDetail.statusId==0)?'selected':''}>【交易】失败</option>
										<option style="height:25px" value="1" ${(settleLoanDetail.statusId==1)?'selected':''}>【交易】成功</option>
										<option style="height:25px" value="2" ${(settleLoanDetail.statusId==2)?'selected':''}>【交易】不明</option>
										<option style="height:25px" value="10" ${(settleLoanDetail.statusId==10)?'selected':''}>【清分】失败</option>
										<option style="height:25px" value="11" ${(settleLoanDetail.statusId==11)?'selected':''}>【清分】成功</option>
									</select>
								</div>
							</div>
							<!-- // 数据来源、发送状态 -->
							...
							<div class="con_core_info_div05">
								...
								<div >
									<textarea style="width:343px; height:111px" name="remark">${settleLoanDetail.remark}</textarea>
								</div>
							</div>
							<!-- // 备注 -->
