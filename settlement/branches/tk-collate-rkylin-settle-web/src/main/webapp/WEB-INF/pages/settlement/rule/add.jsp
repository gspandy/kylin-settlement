...
<body onclick="closeSelect()">
	<div class="area">
		<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/rule/save_ajax">
			<div class="main">
				<div class="blank15"></div>
				<div class="wrap">	
					<div class="con">
						<div class="con_title">
							<h3 class="left fs14 marglr3020">新增对账规则</h3>
							<div class="attr_con">
							...
							<div class="con_article_title02 paddtb20">
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="ruleName" name="ruleName" class="wid190"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									<label class="label_txt wid130 txtright margt10 margr8">
									...
									<div class="input_con_type_top wid190">
										<div class="input_con_type_top wid190">
											<input type="text" id="ruleType" name="ruleType" value="" class="wid190 required" />
										</div>
									</div>
								</div>
								<!-- // 对账规则名称、规则种类 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<div class="input_con_type_top wid190">
											<input type="text" id="readType" name="readType" value="" class="wid190 required" />
										</div>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="detKeyCode" name="detKeyCode" class="wid190 required" title="请输入清算方对账项目"/>
									</div>
								</div>
								<!-- // 上游交易类型、清算方对账项目 -->
								<!-- 上游渠道对账项目、对账名 -->
								...
								<div class="con_core_info_div11" style="padding-left:40px;">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="accKeyCode" name="accKeyCode" class="wid190 required" title="请输入上游渠道对账项目"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="settleKeyName" name="settleKeyName" class="wid190 required" title="请输入对账名"/>
									</div>
								</div>
								<!-- // 上游渠道对账项目、对账名 -->
								<!-- ROP文件批次号、对账类型 -->
