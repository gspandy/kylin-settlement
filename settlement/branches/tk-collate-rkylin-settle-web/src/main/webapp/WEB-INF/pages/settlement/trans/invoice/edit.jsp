...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/trans/invoiceEdit.js"></script>
</head>
<body onclick="closeSelect()">
	<div class="area">
		<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/invoice/edit_ajax">
			<div class="main">
				<div class="blank15"></div>
				<div class="wrap">	
					<div class="con">
						<div class="con_title">
							<h3 class="left fs14 marglr3020">修改结算表信息</h3>
							<div class="attr_con">
						...
						<div class="con_article_title02 paddtb20">
							...
							<div class="con_core_info_div05">
								...
								<label class="label_txt wid190 margt11">
									...
									<input type="hidden" value="${settleTransInvoice.invoiceNo}" name="invoiceNo" />
								</label>
								<label class="label_txt wid130 txtright margt10 margr8">
							...
							<div class="con_core_info_div05">
								...
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="statusId">
										<option style="height:25px" value="0" ${(settleTransInvoice.statusId==0)?'selected':''}>未处理</option>
										<option style="height:25px" value="1" ${(settleTransInvoice.statusId==1)?'selected':''}>发送成功</option>
										<option style="height:25px" value="2" ${(settleTransInvoice.statusId==2)?'selected':''}>发送失败</option>
										<option style="height:25px" value="5" ${(settleTransInvoice.statusId==5)?'selected':''}>已经返回</option>
										<option style="height:25px" value="99" ${(settleTransInvoice.statusId==99)?'selected':''}>异常</option>
									</select>
								</div>
							...
							<div class="con_core_info_div05">
								...
								<label class="label_txt wid190 margt11">
								    ${settleTransInvoice.accountDate}
								</label>
								<label class="label_txt wid130 txtright margt10 margr8">
