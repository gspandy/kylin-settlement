...
public class TransOrderInfoQuery implements Serializable{
	...
	public void setOrderPackageNo(java.lang.String orderPackageNo) {
		this.orderPackageNo = StringUtils.isEmpty(orderPackageNo)||"-1".equals(orderPackageNo)?null:orderPackageNo;
	}
	...
	public void setFuncCode(java.lang.String funcCode) {
		this.funcCode = StringUtils.isEmpty(funcCode)||"-1".equals(funcCode)?null:funcCode;
	}
