...
<body onclick="closeSelect()">
	<div class="area">
		<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/profitkey/edit_ajax">
			<div class="main">
				<div class="blank15"></div>
				<div class="wrap">	
					<div class="con">
						<div class="con_title">
							<h3 class="left fs14 marglr3020">修改清分规则</h3>
							<div class="attr_con">
						...
						<div class="main_con">
							<div class="con_article_title02 paddtb20">
								...
								<div class="con_core_info_div11">
									<input type="hidden" id="profitKeyId" name="profitKeyId" class="wid190" value="${settleProfitKey.profitKeyId}"/>
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="profitRuleName" name="profitRuleName" class="wid190" value="${settleProfitKey.profitRuleName}"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="rootInstCd" name="rootInstCd" value="${settleProfitKey.rootInstCd}" class="wid190 required" title="请输入管理机构代码"/>
									</div>
								</div>
								<!-- // 分润规则名称、管理机构代码 -->
								<!-- 产品号、对应规则明细ID -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="funcCode" name="funcCode" value="${settleProfitKey.funcCode}" class="wid190 required" title="请输入产品号"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="profitDetailId" name="profitDetailId" value="${settleProfitKey.profitDetailId}" class="wid190 required" title="请输入对应规则明细ID"/>
									</div>
								</div>
								<!-- // 产品号、对应规则明细ID -->
								<!-- 规则key1名称、规则key1值 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="keyName1" name="keyName1" class="wid190" value="${settleProfitKey.keyName1}"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									<label class="label_txt wid130 txtright margt10 margr8">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="keyValue1" name="keyValue1" class="wid190" value="${settleProfitKey.keyValue1}"/>
									</div>
								</div>
								<!-- // 规则key1名称、规则key1值 -->
								<!-- 规则key2名称、规则key2值 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="keyName2" name="keyName2" class="wid190" value="${settleProfitKey.keyName2}"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									<label class="label_txt wid130 txtright margt10 margr8">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="keyValue2" name="keyValue2" class="wid190" value="${settleProfitKey.keyValue2}"/>
									</div>
								</div>
								<!-- // 规则key2名称、规则key2值 -->
								<!-- 规则key3名称、规则key3值 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="keyName3" name="keyName3" class="wid190" value="${settleProfitKey.keyName3}"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									<label class="label_txt wid130 txtright margt10 margr8">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="keyValue3" name="keyValue3" class="wid190" value="${settleProfitKey.keyValue3}"/>
									</div>
								</div>
								<!-- // 规则key1名称、规则key1值 -->
								<!-- 状态 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<select style="width:189px;height:28px;" name="statusId">
											<option style="height:25px" value="1" ${settleProfitKey.statusId==1?'selected':''}>有效</option>
											<option style="height:25px" value="0" ${settleProfitKey.statusId==0?'selected':''}>无效</option>
										</select>
									</div>
								</div>
								<!-- 状态 -->
								...
								<div class="con_core_info_div05" style="padding-left:50px;">
									...
									<div class="input_time_type wid190 margt4">
										<input id="checkStartTime" type="text" readonly="readonly"
											name="startTime"
											class="wid140 hasDatepicker" value="<fmt:formatDate value="${settleProfitKey.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"> 
											<a href="javascript:;"
									...
									<div class="input_time_type wid190 margt4">
										<input id="checkEndTime" type="text" readonly="readonly"
											name="endTime"
											class="wid140 hasDatepicker" value='<fmt:formatDate value="${settleProfitKey.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>'> 
											<a href="javascript:;"
								...
								<div class="con_core_info_div11">
									...
									<div >
										<textarea style="width:343px; height:111px" name="remark">${settleProfitKey.remark}</textarea>
									</div>
								</div>
								<!-- // 备注 -->
