...
<div class="area">
	<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/transdetail/query_ajax">
		...
		<!-- 汇总记账 -->
		<input type="hidden" id="doCollectByTrans" 
			name="doCollectByTrans" 
			value="${pageContext.request.contextPath}/settle_kernel_entry/do_collect_by_trans" />
		<div class="main">
			...
			<div class="wrap">
				<div class="con">
					...
					<div class="main_con" style="display: ">
						...
						<div class="con_article_title tit_zindex3 linehei30">
							<b class="left paddl67 paddr10">交易操作</b> <a href="javascript:;"
						...
						<div class="up_or_down_con con_article_title02 tit_zindex6" id="reg2_arrow_con">
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								<label class="label_txt wid135 txtright margr8 margt11">反向交易： </label>
								<a id="accOfOrRefundButt" href="javascript:void(0);" class="chan_btn wid120 margr66 margt5" onclick="doAccOfOrRefund(this)">抹账 || 交易后退款</a>
								<a id="correctButt" href="javascript:void(0);" class="chan_btn wid60 margr30 margt5" onclick="doCorrect(this);">冲正</a>
							</div>
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								<label class="label_txt wid135 txtright margr8 margt11">清分结算： </label>
								<a id="profitBalanceButt" href="javascript:void(0);" class="chan_btn wid120 margr66 margt5" onclick="doProfitBalance(this);">【分润】结算</a>
								<a id="profitButt" href="javascript:void(0);" class="chan_btn wid60 margr30 margt5" onclick="doProfit(this);">清分</a>
							</div>
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">	
								<label class="label_txt wid135 txtright margr8 margt11">挂账冻结： </label>
								<a id="cancelBillButt" href="javascript:void(0);" class="chan_btn wid120 margr66 margt5" onclick="doCancelBill(this);">取消挂账</a>
								<a id="billButt" href="javascript:void(0);" class="chan_btn wid60 margr30 margt5" onclick="doBill(this);">挂账</a>
							</div>
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								<label class="label_txt wid135 txtright margr8 margt11">汇总类型： </label>
								<div class="input_con_type_top wid140 margr55 margt4">
									<select style="width:139px;height:28px;" name="collectType" id="collectType">
										<option style="height:25px" value="1">应收汇总</option>
										<option style="height:25px" value="2">代收付成功汇总</option>
										<option style="height:25px" value="3">代收付失败汇总</option>
										<option style="height:25px" value="4">充值汇总</option>
										<option style="height:25px" value="5">退款/退票汇总</option>
									</select>
								</div>
								<a id="collect_butt" href="javascript:void(0);" class="chan_btn wid110 margr66 margt5" onclick="doCollectByTrans(this)">记账汇总</a>
							</div>
						</div>
