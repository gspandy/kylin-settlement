...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/finanace_account/query.js"></script>
</head>
<div class="area">
	<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/finanaceAccount/query_ajax">
		<div class="main">
			<div class="blank15"></div>
			<div class="wrap">
				<div class="con">
					<div class="con_title">
						<h3 class="left fs14 marglr3020">账户余额查询</h3>
					...
					<div class="main_con" style="display: ">
						...
						<div class="con_article_title02 tit_zindex6" id="reg2_arrow_con">
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								...
								<label class="label_txt wid135 txtright margr8 margt11">账户ID： </label>
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="accountRelateId" id="accountRelateId" />
								</div>
							...
							<div class="con_article_title02 margt10 tit_zindex3">
								...
								<a href="javascript:void(0);" class="right chan_btn wid60 margr30 margt5" onclick="withholdfor40142();">汇总生成平安银企代付</a>
								<input name="withholdfor40142btn" id="withholdfor40142btn" type="hidden" value="${pageContext.request.contextPath}/finanaceAccount/balance40142" />
							</div>
						</div>
