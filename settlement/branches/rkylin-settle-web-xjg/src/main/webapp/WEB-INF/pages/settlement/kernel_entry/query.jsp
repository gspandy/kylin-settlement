							...
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								...
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="collectType" id="collectType">
										<option style="height:25px" value="1">【应收】记账</option>
										<option style="height:25px" value="2">【实收 代收付 成功】记账</option>
										<option style="height:25px" value="3">【实收 代收付 失败】记账</option>
										<option style="height:25px" value="4">【实收 充值】记账</option>
										<option style="height:25px" value="5">【实收 退票 退款】记账</option>
									</select>
								</div>
