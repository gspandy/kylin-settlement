							...
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								...
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="payChannelId" id="payChannelId">
										...
										<option style="height:25px" value="S06">银生宝</option>
									</select>
								</div>
								...
								<div class="input_con_type_top wid190 margt4" id="tldiv">
									<select style="width:189px;height:28px;" name="readType" id="readType">
										<option style="height:25px" class="o_01 o_05 o_S02" value="01">网关对账</option>
										<option style="height:25px" class="o_01 o_04 o_05 o_S01 o_S04 o_S06" value="02">代收付对账</option>
										<option style="height:25px" class="o_01" value="03">移动对账</option>
										...
										<option style="height:25px" class="o_Y02" value="AgentPay_DL">单笔代付(代理)</option>
										<option style="height:25px" class="o_Y02" value="AgentPay_FDL">单笔代付(非代理)</option>
										<option style="height:25px" class="o_Y02" value="Refund_DL">单笔代付退票(代理)</option>
										<option style="height:25px" class="o_Y02" value="Refund_FDL">单笔代付退票(非代理)</option>
										<option style="height:25px" class="o_P01" value="13">会唐国旅</option>
