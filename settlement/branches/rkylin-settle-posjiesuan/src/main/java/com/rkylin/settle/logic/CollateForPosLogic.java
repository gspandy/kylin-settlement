...
public class CollateForPosLogic extends BasicLogic {
	...
	private String[] mailTo = new String[]{"caoyang@rkylin.com.cn","zhangqi4@rkylin.com.cn","liqiuying@rongcapital.cn","tongling@rongcapital.cn"};
...
//		RkylinMailUtil.sendMail("POS收单结束-"+mailDate, mailContext.toString(), mailTo, mailCc);
		...
		RkylinMailUtil.sendAttachmentMail("POS收单结束-"+mailDate, "获取未处理收单交易信息"+ settlePosDetailList.size() +"条", attachment, mailTo, mailCc);
		return resultMap;
	}
	/***
	 * 更新 分润结果表状态 为'已结算'
