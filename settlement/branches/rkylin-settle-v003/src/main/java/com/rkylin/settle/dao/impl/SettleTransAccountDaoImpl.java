...
public class SettleTransAccountDaoImpl extends BaseDao implements SettleTransAccountDao {
	...
	public int updateByMap(Map<String, Object> map) {
		return super.getSqlSession().update("SettleTransAccountMapper.updateByMap", map);
	}
	...
	public List<Map<String, Object>> selectByOrderNo(Map<String, Object> paramMap) {
		return super.getSqlSession().selectList("SettleTransAccountMapperCu.selectByOrderNo", paramMap);
	}
	
	@Override
	public List<Map<String, Object>> selectTestAmountSum(Map<String, Object> paramMap) {
		return super.getSqlSession().selectList("SettleTransAccountMapperCu.selectTestAmountSum", paramMap);
	}
	
	@Override
	public List<Map<String, Object>> selectTestTrans(Map<String, Object> paramMap) {
		return super.getSqlSession().selectList("SettleTransAccountMapperCu.selectTestTrans", paramMap);
	}
}
