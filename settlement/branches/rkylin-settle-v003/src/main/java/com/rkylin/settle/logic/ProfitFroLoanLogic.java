...
//						break;
				...
				if (longProfitAmount < 0) {
					...
					transProfit.setObligate2(rule.getObligate2());
					//存入对账结果List
					...
					transBill.setObligate2(rule.getObligate2());
...
//					}
				...
				if(failIdList.size() > 0) this.updateFailTransProfitStatus(failIdList,e.getMessage().substring(0,250));
				continue;
			}
		}
