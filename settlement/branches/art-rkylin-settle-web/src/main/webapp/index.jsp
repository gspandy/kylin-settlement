  ...
  <body>
	...
	<ul>
		<li>
		    <h2>读取</h2>
			<ol>
				<li><a href="<%=path %>/transdetail/openGetAccTraOrdInfo" target="_blank">读取账户系统交易信息</a></li>
				<li><a href="<%=path %>/transdetail/multi_gate_open_view" target="_blank">读取多渠道交易信息</a></li>
			</ol>
			<h2>对账</h2>
            <ol>	
				<li><a href="<%=path %>/transaccount/collate_file_open_view" target="_blank">下载&读取上游对账文件</a></li>
				<li><a href="<%=path %>/collate/collate_open_view" target="_blank">外部对账</a></li>
            ...
            <ol>	
				...
				<li><a href="<%=path %>/transdetail/update_status_by_record" target="_blank">调用计息更新状态接口</a></li>
			</ol>
			<h2>运营</h2>
            <ol>	
				<li><a href="<%=path %>/compare/openQuery" target="_blank">充值结算对账</a></li>
				<li><a href="<%=path %>/compare/openQueryPage" target="_blank">充值结算对账查询</a></li>
				<li><a href="<%=path %>/invoice/cmbFileUpload" target="_blank">CMB回盘文件读入</a></li>
			</ol>
			<h2>其他</h2>
            <ol>	
    			<li><a href="<%=path %>/position/open_create" target="_blank">头寸:头寸交易信息生成</a></li>
    			<li><a href="<%=path %>/settle_kernel_entry/settle_kernel_entry_manager" target="_blank">调账:悦艺术家汇总调账</a></li>
    			<li><a href="<%=path %>/cav/open_create" target="_blank">核销:悦艺术家核销</a></li>
    		</ol>
    		<h2>辅助</h2>
            <ol>	
    			<li><a href="<%=path %>/collate/open_download_collatefile2merchant" target="_blank">下载服务器对账文件</a></li>
                ...
                <li><a href="<%=path %>/update_acc_to_detail/open_update_acc_to_detail" target="_blank">同步上游和下游的交易信息【手续费】和【协议,渠道】</a></li>
                <li><a href="<%=path %>/transaccount/openTestYFQQueryPage" target="_blank">查询银企直联测试交易并汇总金额</a></li>
                <li><a href="<%=path %>/posdetail/open_select_repay_update_order" target="_blank">查询还款交易手续费并更新订单系统</a></li>
			</ol>
		</li>
	</ul>
	<h1>交易信息相关</h1>
