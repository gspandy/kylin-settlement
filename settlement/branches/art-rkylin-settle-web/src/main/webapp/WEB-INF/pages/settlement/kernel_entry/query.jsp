...
<div class="area">
	<form name="dataForm" id="dataForm" method="post"
		...
		<input type="hidden" id="doKernelEntryForAcc" 
            name="doKernelEntryForAcc" 
            value="${pageContext.request.contextPath}/settle_kernel_entry/do_kernel_entry_for_acc" />
        <input type="hidden" id="doCollectForAcc" 
            name="doCollectForAcc" 
            value="${pageContext.request.contextPath}/settle_kernel_entry/do_collect_for_acc" />
		<div class="main">
			...
			<div class="wrap">
				<div class="con">
					...
					<div class="main_con" style="display: ">
						...
						<div class="con_article_title tit_zindex3 linehei30">
                            <b class="left paddl67 paddr10">悦艺术家交易汇总</b> <a href="javascript:;"
                                class="up_or_down_button margt10 btn_arrow_up" id="reg2_arrow"></a>
                        </div>
                        <div class="up_or_down_con con_article_title02 tit_zindex6" id="reg2_arrow_con">
                            <div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
                                <label class="label_txt wid135 txtright margr8 margt11">汇总类型： </label>
                                <div class="input_con_type_top wid190 margt4">
                                    <select style="width:189px;height:28px;" name="collectType2" id="collectType2">
                                        <option style="height:25px" value="3">线上充值汇总</option>
                                        <option style="height:25px" value="4">提现汇总</option>
                                    </select>
                                </div>
                           
                                <label class="label_txt wid135 txtright margr8 margt11">账期： </label>
                                    <div class="input_time_type wid190 margt4">
                                        <input id="collectAccountDate2" type="text" readonly="readonly"
                                            name="collectAccountDate2"
                                            class="wid140 hasDatepicker" value=""> <a
                                            href="javascript:;"
                                            onclick="WdatePicker({el:'collectAccountDate2',isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd 00:00:00'})"
                                            class="right icon_timer timer_calender margtr36" ></a>
                                    </div>
                            </div>
                            <div class="con_article_title02 margt10 tit_zindex3">
                                <a href="javascript:void(0);" class="right chan_btn wid120 margr66 margt5" onclick="doCollectForAcc(this);">汇总并发送账户</a>
                                <a href="javascript:void(0);" class="right chan_btn wid120 margr30 margt5" onclick="doKernelEntryForAcc(this);" disable>发送账户</a>
                            </div>
                        </div>
