                    ...
                    <div class="main_con" style="display: ">
                           ...
                           <!-- <div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
                            ...
                            <div class="con_article_title02 margt10 tit_zindex3">
                                <a href="javascript:void(0);" class="right chan_btn wid60 margr30 margt5" onclick="createCAVInfo();">开始核销</a>
                            </div>
                    </div>
                </div>
            </div>
...
function createCAVInfo() {
	if(!confirm("您确定要执行:[核销] 操作吗?")) return;
