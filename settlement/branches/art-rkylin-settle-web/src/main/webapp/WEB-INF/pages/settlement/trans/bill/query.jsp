...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/settlement/trans/billQuery.js"></script>
</head>
<div class="area">
	<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/transbill/query_ajax">
		<div class="main">
			<div class="blank15"></div>
			<div class="wrap">
				<div class="con">
					<div class="con_title">
						<h3 class="left fs14 marglr3020">挂账交易信息</h3>
					...
					<div class="main_con" style="display: ">
						...
						<div class="con_article_title02 tit_zindex6" id="reg2_arrow_con">
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								...
								<label class="label_txt wid135 txtright margr8 margt11">挂账条目： </label>
								<div class="input_con_type_top wid190 margt4">
									<input type="text" class="wid190" name="billNo" id="billNo" />
								</div>
							...
							<div class="con_article_title02 margt10 tit_zindex5 paddl52" style="width:90%">
								...
								<label class="label_txt wid135 txtright margr8 margt11 margl16">挂账类型： </label>
								<div class="input_con_type_top wid190 margt4">
									<select style="width:189px;height:28px;" name="billType">
										<option style="height:25px" value="-1">全部</option>
										<option style="height:25px" value="0">差错处理</option>
										<option style="height:25px" value="1">退款</option>
									</select>
								</div>
							</div>
							<div class="con_article_title02 tit_zindex6" id="reg2_arrow_con">
