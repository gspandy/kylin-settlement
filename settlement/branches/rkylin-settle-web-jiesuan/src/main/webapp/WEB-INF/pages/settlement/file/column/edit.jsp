...
<body onclick="closeSelect()">
	<div class="area">
		<form name="dataForm" id="dataForm" method="post" action="${pageContext.request.contextPath}/filecolumn/edit_ajax">
			<div class="main">
				<div class="blank15"></div>
				<div class="wrap">	
					<div class="con">
						<div class="con_title">
							<h3 class="left fs14 marglr3020">修改文件列信息</h3>
							<div class="attr_con">
						...
						<div class="main_con">
							<div class="con_article_title02 paddtb20">
								...
								<div class="con_core_info_div11" style="width:600px;">
									<input type="hidden" name="fileColumnId" value="${settleFileColumn.fileColumnId }"/>
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="fileSubId" name="fileSubId" value="${settleFileColumn.fileSubId }" class="wid190 required integer"/>
									</div>
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="fileColumnNo" name="fileColumnNo" value="${settleFileColumn.fileColumnNo }" class="wid190 required digits"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190">
										<input type="text" id="fileColumnTitle" name="fileColumnTitle" value="${settleFileColumn.fileColumnTitle }" class="wid190 required" title="请输入列名称"/>
									</div>
								</div>
								<!-- // 列号、列名称 -->
								<!-- 交易信息字段、交易信息字段说明 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="fileColumnKeyCode" name="fileColumnKeyCode" class="wid190" value="${settleFileColumn.fileColumnKeyCode }"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									<label class="label_txt wid130 txtright margt10 margr8">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="fileColumnKeyName" name="fileColumnKeyName" class="wid190" value="${settleFileColumn.fileColumnKeyName }"/>
									</div>
								</div>
								<!-- // 交易信息字段、交易信息字段说明 -->
								<!-- 是否特殊列、数据类型 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<select style="width:189px;height:28px;" name="isSpecialColumn">
											<option style="height:25px" value="0" ${settleFileColumn.isSpecialColumn==0?'selected':'' }>否</option>
											<option style="height:25px" value="1" ${settleFileColumn.isSpecialColumn==1?'selected':'' }>是</option>
										</select>
									</div>
								</div>
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<select style="width:189px;height:28px;" name="dataType">
											<option style="height:25px" value="1" ${settleFileColumn.dataType==1?'selected':'' }>字符串</option>
											<option style="height:25px" value="2" ${settleFileColumn.dataType==2?'selected':'' }>数字</option>
											<option style="height:25px" value="3" ${settleFileColumn.dataType==3?'selected':'' }>日期</option>
										</select>
									</div>
								</div>
								<!-- // 是否特殊列、数据类型 -->
								...
								<div class="con_core_info_div11">
									...
									<div class="input_con_type_top wid190 margt4">
										<input type="text" id="dataFormat" name="dataFormat" class="wid190" value="${settleFileColumn.dataFormat }"/>
									</div>
								</div>
								<div class="con_core_info_div11">
									<label class="label_txt wid130 txtright margt10 margr8">
									...
									<div class="input_con_type_top wid190 margt4">
										<select style="width:189px;height:28px;" name="statusId">
											<option style="height:25px" value="1" ${settleFileColumn.statusId==1?'selected':'' }>有效</option>
											<option style="height:25px" value="0" ${settleFileColumn.statusId==0?'selected':'' }>无效</option>
										</select>
									</div>
								</div>
								<!-- // 数据格式、状态 -->
								...
								<div class="con_core_info_div05" style="padding-left:50px;">
									...
									<div class="input_time_type wid190 margt4">
										<input id="checkStartTime" type="text" readonly="readonly"
											name="startTime"
											class="wid140 hasDatepicker"  value='<fmt:formatDate value="${settleFileColumn.startTime }" pattern="yyyy-MM-dd HH:mm:ss"/>'> 
											<a href="javascript:;"
									...
									<div class="input_time_type wid190 margt4">
										<input id="checkEndTime" type="text" readonly="readonly"
											name="endTime"
											class="wid140 hasDatepicker"  value='<fmt:formatDate value="${settleFileColumn.endTime }" pattern="yyyy-MM-dd HH:mm:ss"/>'> 
											<a href="javascript:;"
								...
								<div class="con_core_info_div11">
									...
									<div >
										<textarea style="width:343px; height:111px" name="remark">${settleFileColumn.remark }</textarea>
									</div>
								</div>
								<!-- // 备注 -->
