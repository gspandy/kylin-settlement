...
public class SettleTransBillDaoImpl extends BaseDao implements SettleTransBillDao {
    ...
    @Override
    public List<SettleTransBill> selectByPreExample(SettleTransBillQuery example) {
        return super.getSqlSession().selectList("SettleTransBillMapper.selectByPreExample", example);
    }

    @Override
    public int updateSettleTransBillByOrderNo(SettleTransBill record) {
        return super.getSqlSession().update("SettleTransBillMapper.updateSettleTransBillByOrderNo", record);
    }
