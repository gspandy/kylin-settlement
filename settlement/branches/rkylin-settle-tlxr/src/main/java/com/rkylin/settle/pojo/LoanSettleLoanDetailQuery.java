...
/**
 * LoanSettleLoanDetailQuery
 * @author code-generator
 *
 */
public class LoanSettleLoanDetailQuery implements Serializable{
	 ...
	 * @param onePaymenyFlg
	 */
	public void setOnePaymenyFlg(Integer onePaymenyFlg) {
		this.onePaymenyFlg = onePaymenyFlg;
	}
	 ...
	 * @return
	 */
	public Integer getOnePaymenyFlg() {
		return this.onePaymenyFlg;
	}
	/**
	 * 还款期数(初始为0)
	 * @param repaymentCnt
