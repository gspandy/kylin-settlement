...
import com.rkylin.settle.filedownload.InowPayFileDownload;
...
public class SettleWebInterfaceImpl implements SettleWebInterface {
	...
	@Autowired
	private InowPayFileDownload inowPayDownload;
...
//	}
	...
	@Override
	public Map<String, String> inowPayFileDown(String accountDate,
			String marchantCode) throws Exception {
		return inowPayDownload.fileDown(accountDate, marchantCode);
	}
}
